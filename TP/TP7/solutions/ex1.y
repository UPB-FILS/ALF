...
statements: statement NEWLINE statements	{
            ...
            ;
statement : expression                      { $$ = rule('statement', [$1], yylineno)}
          | expression_string               { $$ = rule('statement', [$1], yylineno)}
          | variable                        { $$ = rule('statement', [$1], yylineno)}
          | function                        { $$ = rule('statement', [$1], yylineno)}
          | function_run                    { $$ = rule('statement', [$1], yylineno)}
          | assign                          { $$ = rule('statement', [$1], yylineno)}
          ;
