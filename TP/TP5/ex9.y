...
declaration
: INT VARIABLE ATTRIBUTION expression                               {console.log($1 + ' ' + $2 + ' ' + $3 + ' ' + $4);}
| DOUBLE VARIABLE ATTRIBUTION expression                            {console.log($1 + ' ' + $2 + ' ' + $3 + ' ' + $4);}
| STRING VARIABLE ATTRIBUTION expression_string                     {console.log($1 + ' ' + $2 + ' ' + $3 + ' ' + $4);}
| BOOLEAN VARIABLE ATTRIBUTION expression_boolean                   {console.log($1 + ' ' + $2 + ' ' + $3 + ' ' + $4);}
;
