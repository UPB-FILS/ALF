...
case 14:
    ...
    if(!matching (yyvstack[yysp - 2], yyvstack[yysp], yyvstack[yysp - 1]))
    ...
    this.$ = {
        ...
        right: yyvstack[yysp],
        exprType: getType (yyvstack[yysp - 2], yyvstack[yysp], yyvstack[yysp - 1]),
        line: yylineno + 1
    };
    break;
...
case 17:
    /*! Production::    expression : STRING_VALUE */
...
case 19:
    ...
    if(isDefined(yyvstack[yysp]))
        return 'ERROR: The variable ' + yyvstack[yysp] + ' is already defined.'
    addVariable (yyvstack[yysp], 'unknown');
...
case 21:
    /*! Production::    variables : variables "," IDENTIFIER "[" type "]" */
    ...
    if(isDefined(yyvstack[yysp - 3]))
        return 'ERROR: The variable ' + yyvstack[yysp - 3] + ' is already defined.'
    addVariable (yyvstack[yysp - 3], yyvstack[yysp - 1]);
...
case 22:
    /*! Production::    variables : IDENTIFIER "[" type "]" */
...
case 26:
    ...
    symbol_table[yyvstack[yysp - 2]].type = yyvstack[yysp].exprType;
    this.$ = {
        type: 'assign',
        to: {
            id: yyvstack[yysp - 2],
...
case 27:
    /*! Production::    array : LIST IDENTIFIER "=" "[" array_elements "]" */
    ...
    this.$ = {
        ...
        array: yyvstack[yysp - 4],
        elements: yyvstack[yysp - 1],
        line: yylineno + 1
    }
    break;

case 28:
    /*! Production::    array_elements : array_elements "," expression */
case 35:
...
case 29:
    /*! Production::    array_elements : expression */
case 36:
...
case 30:
    ...
    addFunction(yyvstack[yysp - 7], yyvstack[yysp - 5]);
    this.$ = {
...
case 31:
    /*! Production::    parameters : parameters "," IDENTIFIER "[" type "]" */
    ...
    addVariable(yyvstack[yysp - 3], 'parameter');
    yyvstack[yysp - 5].push({
        id: yyvstack[yysp - 3],
        type: yyvstack[yysp - 1],
        line: yylineno + 1
...
case 32:
    /*! Production::    parameters : IDENTIFIER "[" type "]" */
...
case 34:
    /*! Production::    function_call : IDENTIFIER LP parameters_run RP */
...
parse: function parse(input) {
    ...
    var NO_ACTION = [0, 76 /* === table.length :: ensures that anyone using this new state will fail dramatically! */];
